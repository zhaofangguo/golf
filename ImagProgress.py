...
def ImagProgress(filename):
    ...
    # cv.imshow('add', dark)
    circles = cv.HoughCircles(MedirImag, cv.HOUGH_GRADIENT, 1, 100, param1=1, param2=10, minRadius=1, maxRadius=1000)
...
if __name__ == "__main__":
    frame = cv.imread('smallredball.jpg')
    ImagProgress(frame)
